...
//   } else {
//     setCourseData({ courseContent: [] }); // Safe fallback to avoid crash
//   }}
// })
...
const Player = () => {
  ...
  const getCourseData = () => {
    ...
    if (foundCourse) {
      ...
      setCourseData({ courseContent: [] }); // safe fallback
       }
  };
  const toggleSection = (index) => {
    setOpenSections(prev => ({ ...prev, [index]: !prev[index] }));
      ...
      <div className="p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36">
        ...
        <div className="text-gray-800">
          ...
          {!courseData?.courseContent?.length && (
            <p className="text-gray-500 mt-4">No course content available for this course.</p>
          )}
                          ...
                          <li key={i} className="flex items-start gap-2 py-1">
                            ...
                            <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-default">
                              ...
                              <div className="flex gap-2">
                                ...
                                <p> {lecture?.lectureDuration ? humanizeDuration(lecture.lectureDuration * 60 * 1000, { units: ["h", "m"],}) : "0m"}  </p>  </div> </div> </li>   ))}   </ul>  </div>   </div>   ))}  </div>
